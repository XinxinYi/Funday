...
public class CompressPicDemo {
   ...
   public static void main(String[] arg) {   
       ...
       System.out.println("输入的图片大小：" + mypic.getPicSize("f:\\22.gif")/1024 + "KB");   
       int count = 0; // 记录全部图片压缩所用时间  
       for (int i = 0; i < 2; i++) {   
           int start = (int) System.currentTimeMillis();   // 开始时间   
           mypic.compressPic("f:\\", "f:\\test\\", "22.gif", "r1"+i+".gif", 2020, 2020, true);   
           int end = (int) System.currentTimeMillis(); // 结束时间   
           int re = end-start; // 但图片生成处理时间   
           count += re; System.out.println("第" + (i+1) + "张图片压缩处理使用了: " + re + "毫秒");   
           System.out.println("输出的图片大小：" + mypic.getPicSize("f:\\test\\r1"+i+".gif")/1024 + "KB");   
       }  
